...
import ma.cam.auth.exception.base.BusinessException;
import ma.cam.auth.exception.base.UnauthorizedException;
 ...
 *         the
 *         {@link ma.cam.auth.api.error.api.error.CustomErrorResponse}
 *         CustomErrorResponse
 */
@Slf4j
@ControllerAdvice
